<x-guest-layout>
    <h4 class="pb-4 font-bold text-3xl font-mali">Tambah Penduduk</h4>
    <!-- Session Status -->
    ...
    <form method="POST" action="/penduduk/add">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="jumlah_penduduk" class="block mt-1 w-full" type="text" name="jumlah_penduduk" :value="old('jumlah_penduduk')" required autocomplete="tel" />
